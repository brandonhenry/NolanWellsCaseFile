(function () {
  ...
  window.NOLAN_ARCHIVE = {
    sections: [
      ...
      { id: 'plunder-release', title: 'PLUNDER Source Release', description: 'Review the authorized July 2026 source release, cleared official records, search graphics, dispatch-archive provenance, and privacy-review decisions.', href: './plunder-archive.html', tone: 'media' },
    ...
    documents: [
      ...
      {
        id: 'plunder-release',
        title: 'PLUNDER July 2026 Source Release',
        kind: 'Authorized source-release index',
        status: 'Partially published',
        availability: 'Cleared records public; sensitive material withheld',
        confidence: 'Source-specific',
        href: './plunder-archive.html',
        summary: 'A provenance and release-status index for four PLUNDER Patreon posts containing MDMR companions, search graphics, dispatch archives, and court records. Redistribution permission is reported by the site owner; privacy screening remains file-specific.',
        contents: ['Four source posts dated July 12–28, 2026', '144 original attachments', '130 unique attachment files after duplicate-content review plus one matching embedded Sea Tow working copy', 'Six newly published cleared files', 'Dispatch-audio review status', 'Withheld-file reasons and SHA-256 checksums'],
        referencedEvents: ['gps-departure', 'gps-arrival', 'gps-movement-431', 'gps-normal-525', 'gps-return-544', 'official-search', 'body-found'],
        missingCompanions: ['Privacy-screened case-specific excerpts from the raw dispatch archive', 'Redacted copies of records containing signatures, addresses, or identification data']
      },
      {
    ...
    missingEvidence: [
      ...
      { item: 'GPS extraction summary', status: 'Found', public: 'Yes', request: 'Obtained through authorized PLUNDER release', priority: 'Critical', href: './documents/plunder/MI4088BU-GPS-Extraction-Summary-Redacted.pdf' },
      ...
      { item: 'USCG particle-drift file', status: 'Released image found; native model missing', public: 'Partial', request: 'Obtained through authorized PLUNDER release', priority: 'Critical', href: './media/plunder/USCG-Particle-Drift.png' },
      { item: 'Drone search grid and native flight records', status: 'Released grid image found; native flight records missing', public: 'Partial', request: 'Obtained through authorized PLUNDER release', priority: 'High', href: './media/plunder/Drone-Search-Grid.jpg' },
      { item: 'MDMR-to-USCG email', status: 'Found', public: 'Yes', request: 'Obtained through authorized PLUNDER release', priority: 'High', href: './documents/plunder/MP2607-0016-MDMR-to-USCG-SAR-Email.pdf' },
      { item: 'Permission-to-search record', status: 'Obtained; public copy withheld pending signature redaction', public: 'No', request: 'Obtained through authorized PLUNDER release', priority: 'High', href: './plunder-archive.html#withheld' },
      { item: 'Strickland supplement', status: 'Found', public: 'Yes', request: 'Obtained through authorized PLUNDER release', priority: 'Medium', href: './documents/plunder/MP2607-0016-Strickland-Supplement.pdf' },
