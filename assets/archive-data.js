(function () {
  ...
  window.NOLAN_ARCHIVE = {
    sections: [
      ...
      { id: 'videos', title: 'Video Archive', description: 'Watch preserved interview reels and source excerpts, then open the complete Officer Tatum, Cuomo, NewsNation, and Nancy Grace programs for full context.', href: './video-archive.html', tone: 'media' },
    ...
    documents: [
      ...
      },
      {
        ...
        title: 'Nancy Grace · Horn Island Nearshore Panorama',
      ...
      },
      {
        ...
        summary: 'Preserves case-related material from six audited July Facebook threads plus selected public posts and screenshots, including the July 5 public preservation and July 6 image-set preservation of Katelynn Brochard’s complete exchange, the exposed-comment audit, and the working-report configuration comparison, with visible times, permalinks, local copies, hashes, and claim-level assessments.',
        contents: ['Attributed Faith Lauren witness and reporting-intent screenshots', 'Attributed Katie Hudson Seymour message screenshots and 5:00 PM claim', 'East Tip scene submissions', 'Lucas Aviz apparent last-contact screenshot', 'Stephen Ray tentative sighting', 'Anna C. Moore clarification', 'Ivy Elizabeth direct reply', 'Katelynn Brochard July 5 public preservation, July 6 complete-exchange image set, direct reply, exposed-comment audit, clarification capture, and derivative repost images', 'Working-report Figures 6B and 10 comparison', 'Matthew Lamp passenger-account screenshots', 'Search-participation reports', 'Machine-readable JSON ledger', 'SHA-256 hashes'],
        referencedEvents: ['faith-lauren-reporting-intent', 'ivy-video-account', 'katelynn-nearby-account', 'east-tip-photo-submission', 'family-private-search-0600', 'official-search', 'anna-clarification'],
    ...
    people: [
      ...
      },
      {
        ...
        role: 'Named public source claimant',
        summary: 'Attributed statements say Nolan introduced himself to her husband, her group was parked directly beside Nolan’s group, and Nolan was not in sight when her group left at 7:30 PM. A July 5 public post preserves the first statement and attached scene photograph; a July 6 post preserves the complete exchange without the later video overlay. These dates establish circulation, not capture. A repeated clarification says an unresolved “they” left around 5, and the working report reuses her scene photograph for a Palm Beach/Triton/Boat #3 comparison. This remains a local no-sight observation, not Nolan’s established location or a case-wide last sighting.',
        eventIds: ['katelynn-nearby-account'],
        interviews: [{ label: 'Complete screenshots, full exposed-comment audit, report comparison, and source assessment', href: './social-source-ledger.html#katelynn-boats-account' }],
        questions: ['When did she last personally see Nolan?', 'What exact boat and location did her group occupy?', 'Who did “they” refer to in the separate around-5:00 statement?', 'Did she see or hear the reported fight or boarding discussion?', 'Can the native parent thread and scene-media metadata be recovered?'],
        recordStatus: 'Named firsthand account · medium confidence'
      },
      {
        id: 'matthew-lamp',
        name: 'Matthew Lamp',
    ...
    entityGraph: {
      ...
      relationships: [
        ...
        { id: 'katelynn-horn-island', from: 'katelynn-brochard', to: 'horn-island', label: 'Describes adjacent group and 7:30 departure', status: 'witness', confidence: 'Medium', claim: 'She says Nolan introduced himself to her husband, her group was parked directly beside Nolan’s group, and Nolan was not in sight in that adjacent area when her group left at 7:30 PM. A July 5 public post dates circulation of the first statement and photo; a repeated clarification says an unresolved “they” left around 5; the working report reuses her photo for a Palm Beach/Triton/Boat #3 comparison.', sourceLabel: 'Katelynn July 5 preservation, statements, and report comparison', source: './social-source-ledger.html#katelynn-boats-account' },
