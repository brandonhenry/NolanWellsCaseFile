  ...
  window.NOLAN_ARCHIVE = {
    ...
    documents: [
      ...
      },
      {
        ...
        summary: 'Preserves case-related material from six audited July Facebook threads plus selected public posts and supplied screenshots, including the complete Katelynn Brochard reply frame, the exposed-comment audit, and the working-report configuration comparison, with visible times, permalinks, local copies, hashes, and claim-level assessments.',
        contents: ['Attributed Faith Lauren witness and reporting-intent screenshots', 'Attributed Katie Hudson Seymour message screenshots and 5:00 PM claim', 'East Tip scene submissions', 'Lucas Aviz apparent last-contact screenshot', 'Stephen Ray tentative sighting', 'Anna C. Moore clarification', 'Ivy Elizabeth direct reply', 'Katelynn Brochard complete reply frame, direct reply, exposed-comment audit, clarification capture, and derivative repost images', 'Working-report Figures 6B and 10 comparison', 'Matthew Lamp passenger-account screenshots', 'Search-participation reports', 'Machine-readable JSON ledger', 'SHA-256 hashes'],
    ...
    people: [
      ...
      },
      {
        ...
        role: 'Named public source claimant',
        summary: 'Attributed statements say Nolan introduced himself to her husband, her group was parked directly beside Nolan’s group, and Nolan was not in sight when her group left at 7:30 PM. A repeated clarification says an unresolved “they” left around 5, and the working report reuses her scene photograph for a Palm Beach/Triton/Boat #3 comparison. This remains a local no-sight observation, not Nolan’s established location or a case-wide last sighting.',
    ...
    entityGraph: {
      ...
      relationships: [
        ...
        { id: 'katelynn-horn-island', from: 'katelynn-brochard', to: 'horn-island', label: 'Describes adjacent group and 7:30 departure', status: 'witness', confidence: 'Medium', claim: 'She says Nolan introduced himself to her husband, her group was parked directly beside Nolan’s group, and Nolan was not in sight in that adjacent area when her group left at 7:30 PM. A repeated clarification says an unresolved “they” left around 5; the working report reuses her photo for a Palm Beach/Triton/Boat #3 comparison.', sourceLabel: 'Katelynn preserved statements and report comparison', source: './social-source-ledger.html#katelynn-boats-account' },
